...
import {SSO_ROUTE_PATH, ssoCookieMiddleware} from './sso';
...
function addMiddleware(devServer) {
  // TODO resolve the sso cookie issue
  devServer.use(SSO_ROUTE_PATH, ssoCookieMiddleware(paths.appDirectory + '/.roadhogrc'));
